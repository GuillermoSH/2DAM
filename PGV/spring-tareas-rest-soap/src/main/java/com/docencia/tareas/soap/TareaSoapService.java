...
@WebService(serviceName = "TareaService", portName = "TareaPort", targetNamespace = "http://ies.puerto.es/ws/tarea", endpointInterface = "com.docencia.tareas.soap.ITareaSoapEndpoint")
@Service
